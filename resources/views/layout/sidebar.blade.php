      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <!-- คู่มือ & FAQ -->
          <li class="nav-item ">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a class="nav-link" href="{{ asset('Manual_DIR/DRDS_manuals_1-5-25.pdf') }}" target="_blank">
        ...
        <!-- ประกาศ -->
          ...
          <li class="nav-header">ANNOUNCEMENT</li>
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{ asset('Manual_DIR/announce_researcher_level_020425.pdf') }}" target="_blank">
